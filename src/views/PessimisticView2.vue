<template>
  <div class="flex justify-center relative w-full h-full m-10">
    <div v-if="isSaving" class="absolute w-full h-full bg-white opacity-60 "></div>  
    <div v-if="isSaving" class="absolute w-full h-full flex justify-center items-center font-black">Saving...</div>  
